// Inline type definitions (replaces ollama SDK types for browser compatibility)
interface SearchRequest { query: string; max_results?: number }
interface SearchResponse { results: Array<{ title?: string; url?: string; content?: string }> }
interface FetchRequest { url: string }
interface FetchResponse { content?: string; title?: string; url?: string }
