/**
    ...
    async function testWebsearchTools(): Promise<TestResult> {
      ...
      try {
        const client = await getTestClient();
        const prompt = 'What is the latest testing release of Node.js? Keep answer to one or two sentences. try to include meta information';
        const webSearchTool = {
          type: 'function',
          function: {
            name: 'webSearch',
    ...
    const SUITE_A = [//testWebsearchTools
    /*,
      testCalculator,
      testFlightTracker,
      testMultiTool,*/
